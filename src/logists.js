...
const LOGISTS = [
  ...
  },
  {
    ...
    contactId: 124,
    companyIds: [1480, 9413, 4176, 219, 9179, 17742], // КТЗ, Гифт, Металл Профиль, Миррико, Завод Стройдеталь, ТД Дача
  },
  {
    name: 'Якимов Михаил',
  ...
  },
  {
    ...
    contactId: 141,
    companyIds: [14779, 91, 11215], // ГК АСК, Дикомп-Классик, Северсталь-метиз
  },
  {
    name: 'Тачанская Венера',
    token: 'a415816e69d247b0ae3a824db1a6ba11',
    contactId: 126,
    companyIds: [792, 3133], // Хаят, Татпром-Холдинг
  },

  // Логисты с токенами, пока без закреплённых company_id:
  {
    name: 'Тупенов Кайрат',
